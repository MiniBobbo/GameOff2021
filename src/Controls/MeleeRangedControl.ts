...
export class MeleeRangedControl extends Phaser.GameObjects.Container {
    ...
    constructor(gs:GameScene, attacker:Unit, defender:Unit) {
        ...
        this.add(gs.add.bitmapText(0,0, '6px', 'Choose Melee or Ranged' ));
        ...
        if(attacker.MeleeAttack != null) {
            ...
            this.melee.on('pointerdown', (p:any, x:any, y:any, e:Phaser.Types.Input.EventData) => {gs.events.emit(SceneEvents.ChooseMeleeAttack); e.stopPropagation();});
        } else {
